...
def rss_preprocessor(session, feed_url: str, publication_id: str | None = None, issn: str | None = None) -> List[dict]:
    ...
    """
    res = feeds.fetch_feed(session, '', feed_url, publication_doi=publication_id, issn=issn) if hasattr(feeds, 'fetch_feed') else {}
